/* 	3. CalcSIRLogLinearTransDom:
		...
		f. O cálculo é feito considerando-se chirp transiente como dominante (chirp adiabático é nulo)
*/
...
//             Jnp1 = J(nk[k]+1, u); //_jn
            ...
            SDeltaJ += (mIM[k]*ctheta*nk[k]/u);
            ProdJn *= Jn;
        }
    }
    SDeltaJ = ProdJn*(1 - SDeltaJ);    

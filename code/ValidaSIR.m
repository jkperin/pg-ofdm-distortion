...
FF = F/1e9;
figure
plot(FF, SIRteo, 'sk', FF, SIRap1, 'or', FF, SIRap2, 'dm', FF, loglinear.SIR, '*-b', FF, loglinearm.SIR, '*k', FF, analitico.SIR.SIR, 'ok')
legend('Teórico', 'Log Linear Numérico', 'Log Quad Numérico', 'Analítico Linear C++','Analítico Linear Matlab', 'Eq. Fechada');

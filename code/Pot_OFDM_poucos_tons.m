...
teorico.Pot = 10*log10(corta(mean(SIGteo,1),indF)/1e-3);
aprox1.Pot = 10*log10(corta(mean(SIGap1,1),indF)/1e-3);
aprox2.Pot = 10*log10(corta(mean(SIGap2,1),indF)/1e-3);
...
FF = F/1e9;
figure
plot(FF, teorico.Pot, 'sk', FF, aprox1.Pot, 'or', FF, aprox2.Pot, 'dm', FF, loglinear.Pot, '*b', FF, analitico2.Pot, '*k')
legend('Teórico', 'Log Linear Numérico', 'Log Quad Numérico', 'Analítico Linear', 'Analítico Quad');

...
fc = 3.5e9;         % Frequência central (Hz)
Deltaf = 50e6;
...
%     teorico.Idet = teorico.Idet.*filt;
%     teorico.IMPdet = teorico.IMPdet.*filt;
% 
%     aprox1.Idet = aprox1.Idet.*filt;
%     aprox1.IMPdet = aprox1.IMPdet.*filt;
%     aprox2.Idet = aprox2.Idet.*filt;
%     aprox2.IMPdet = aprox2.IMPdet.*filt;
    
%     teorico.Idet = corta(teorico.Idet, indF);
%     aprox1.Idet = corta(aprox1.Idet, indF);
%     aprox2.Idet = corta(aprox2.Idet, indF);
%     
%     teorico.IMPdet = corta(teorico.IMPdet, indF);
%     aprox1.IMPdet = corta(aprox1.IMPdet,indF);
%     aprox2.IMPdet = corta(aprox2.IMPdet,indF);
...
% SIRpsi = corta(10*log10(mean(SIGpsi,1)./mean(IMDpsi,1), indF));
toc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
FF = F/1e9;
figure
plot(FF, SIRteo, 'sk', FF, loglinear.SIR, '*b')
legend('Teórico', 'Analítico');
